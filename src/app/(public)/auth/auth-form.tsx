        ...
        <div className="w-full max-w-md mx-auto">
          ...
          <div className="bg-white rounded-3xl shadow-lg p-8 md:p-10">
            <div className="text-center mb-8">
              ...
              <p className="text-sm text-slate-500">
                Saisissez votre numéro de téléphone et votre code d&apos;accès à 4 chiffres.
              </p>
            </div>
            ...
            <form action={parentAction} className="space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    autoComplete="tel"
                    disabled={parentPending || parentSubmitted}
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  pattern="[0-9]{4}"
                  placeholder="0000"
                  className="input text-center text-2xl tracking-[0.5em] tracking-widest text-slate-800"
              ...
              <button
                ...
                disabled={parentPending || parentSubmitted}
                onClick={() => {
                  if (!parentPending && !parentSubmitted) setParentSubmitted(true);
                }}
