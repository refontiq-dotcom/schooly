      ...
      >
        ...
        <div className="px-6 py-6">
          <Link href="/" className="flex items-center gap-2">
            {logoUrl ? (
              <img src={logoUrl} alt={establishmentName} className="w-8 h-8 rounded-lg object-cover" />
            ) : (
            ...
            <span className="text-lg font-bold text-slate-800 tracking-tight">{establishmentName || "Schooly"}</span>
          </Link>
        </div>
        ...
        <div className="px-5 py-4 mx-3 mb-2 bg-slate-50 rounded-2xl">
          <div className="flex items-center gap-3">
            {logoUrl ? (
              ...
              <div className="w-11 h-11 rounded-xl bg-gradient-to-br from-amber-400 to-orange-400 flex items-center justify-center text-white font-bold text-sm shadow-sm">
                {establishmentName?.charAt(0) ?? "A"}
              </div>
            )}
